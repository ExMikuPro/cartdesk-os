...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of lua */
  luaHandle = osThreadNew(StartLuaTask, NULL, &lua_attributes);
...
/* USER CODE BEGIN Header_StartLuaTask */
/**
* @brief Function implementing the lua thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLuaTask */
void StartLuaTask(void *argument)
{
  /* USER CODE BEGIN StartLuaTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartLuaTask */
}
